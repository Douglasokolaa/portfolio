...
<head>
	...
	<title>Douglas Okolaa</title>
	<meta name="description" content="I am Douglas Okolaa, A Fullstack Web Developer with experience in LAMP , MERN and MEAN stack" />
	<meta name="keywords" content="Douglas Okolaa, Okolaa , Douglas" />
	<meta name="author" content="Douglas Okolaa" />
	<meta name="theme-color" content="#2a2d35">

	<!-- Assets-->
	<link rel="stylesheet" href="assets/css/vendor.min.css" />	
	<link href="assets/css/mason-dark.min.css" rel="stylesheet">
</head>
    	...
    	<section class="section-home" id="about">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-md-9">
						<div class="home-left">
			    			<span class="hello mb-2 d-block">Hello, <img src="assets/images/waving-hand.png"></span>
			    			<h1 data-text="I’m Douglas Okolaa">I’m Douglas Okolaa</h1>
			 	   			<p class="my-4"><span class="typed" data-elements="A Fullstack Developer, A Website Manager.,."></span></p>
	 	   			...
	 	   			<div class="col-md-3">
							...
							<div class="tooltip">
								<ul class="list-unstyled list-inline">
									<li class="list-inline-item"><a href="https://ng.linkedin.com/in/douglas-okolaa"><i class="fab fa-linkedin"></i></a></li>
									<li class="list-inline-item"><a href="https://twitter.com/douglasokolaa"><i class="fab fa-twitter"></i></a></li>
									<li class="list-inline-item"><a href="https://github.com/douglasokolaa"><i class="fab fa-github"></i></a></li>
								</ul>
							</div>
						  	<svg>
		...
		<section class="section section-about">
			<div class="container">
				<div class="row justify-content-center align-items-center">
					...
					<div class="col-md-6">
						<div class="simpleParallax-wrap">
							<img class="thumbnail img-fluid d-block wow fadeInUp" src="assets/images/avatar.jpg" alt="About Picture">
							<img class="about-dots" src="assets/images/dots.svg" alt="About dots">
						</div>
					</div>
						...
						<div class="about-desc">
							<div class="about-desc-content text-left">
								...
								<p class="mt-5 mb-4">
									...
									Performance-driven and motivated Full Stack Developer with 
									2 years experience in participating 
									in all phases of software development
<!-- 
									Dedicated and efficient full stack developer with

									Possess a strong attention to detail, well-developed time management skills, 
									and ability to complete all projects within schedule and in a timely manner.

									Passionate designer & developer who loves simplicity in things
									 and crafts beautiful user interfaces with love. -->
								</p>
				...
				<div class="row">
						...
						<div class="portfolio-item mb-5">
							...
							<div class="portfolio-item--content">
								<div class="portfolio-item--image">
									<img src="assets/images/p1-1.jpg" alt="" class="mx-auto s/website.css">
								</div>
					...
					<div class="col-md-6 col-lg-5 ml-auto">
						<div class="portfolio-item mb-5 mt-md-150">
							...
							<div class="portfolio-item--content">
								<div class="portfolio-item--image">
									<img src="assets/images/p2-2.jpg" alt="" class="mx-auto s/website.css">
								</div>
								<div class="portfolio-item--desc">
									<a href="#" class="btn">View case Study</a>
								</div>
					...
					<div class="col-md-6 col-lg-5">
						<div class="portfolio-item mb-5">
							...
							<div class="portfolio-item--content">
								<div class="portfolio-item--image">
									<img src="assets/images/p3-3.jpg" alt="" class="mx-auto s/website.css">
								</div>
								<div class="portfolio-item--desc">
									<a href="#" class="btn">View case Study</a>
								</div>
					...
					<div class="col-md-6 col-lg-5 ml-auto">
						<div class="portfolio-item mb-5 mt-md-150">
							...
							<div class="portfolio-item--content">
								<div class="portfolio-item--image">
									<img src="assets/images/p4-4.jpg" alt="" class="mx-auto s/website.css">
								</div>
								<div class="portfolio-item--desc">
									<a href="#" class="btn">View case Study</a>
								</div>
					...
					<div class="col-md-6 col-lg-5">
						<div class="portfolio-item mb-5">
							...
							<div class="portfolio-item--content">
								<div class="portfolio-item--image">
									<img src="assets/images/p5-5.jpg" alt="" class="mx-auto s/website.css">
								</div>
								<div class="portfolio-item--desc">
									<a href="#" class="btn">View case Study</a>
								</div>
					...
					<div class="col-md-6 col-lg-5 ml-auto">
						<div class="portfolio-item mb-5 mt-md-150">
							...
							<div class="portfolio-item--content">
								<div class="portfolio-item--image">
									<img src="assets/images/p6-6.jpg" alt="" class="mx-auto s/website.css">
								</div>
								<div class="portfolio-item--desc">
									<a href="#" class="btn">View case Study</a>
								</div>
					...
					<div class="swiper-container swiper-testimony wow fadeInUp"  data-wow-duration="1.5s">
						<div class="swiper-wrapper">
							<div class="swiper-slide single-testimonials ">
								<div class="single-testimonials-in text-center p-3 p-md-5  mx-auto">
									<img src="assets/images/testimony-1.jpg" alt="" class="mx-auto">
									...
									<span class="font-weight-bold mt-3 d-block">- Alice Joseph, Web Developer</span>
								</div>
							</div>

							<div class="swiper-slide single-testimonials ">
								<div class="single-testimonials-in text-center p-3 p-md-5 mx-auto">
									<img src="assets/images/testimony-2.jpg" alt="" class="mx-auto">
									...
									<span class="font-weight-bold mt-3 d-block">- Anton Fean, Web Developer</span>
								</div>
							</div>

							<div class="swiper-slide single-testimonials ">
								<div class="single-testimonials-in text-center p-3 p-md-5  mx-auto">
									<img src="assets/images/testimony-3.jpg" alt="" class="mx-auto">
									<p class="pt-2 mt-4 text-center">"Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse."</p>
									<span class="font-weight-bold mt-3 d-block">- Princy, Web Developer</span>
								</div>
							</div>
							...
							<div class="swiper-slide single-testimonials ">
								<div class="single-testimonials-in text-center p-3 p-md-5  mx-auto">
									<img src="assets/images/testimony-1.jpg" alt="" class="mx-auto">
									<p class="pt-2 mt-4 text-center">"Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse."</p>
									<span class="font-weight-bold mt-3 d-block">- Choloe Decker, Web Developer</span>
								</div>
							</div>
						...
						<div class="testimony-pagination"></div>
					</div>
								...
								<form id="contact_me">
									<div class="contact-form--wrap p-4 p-md-5">
										...
										<div class="form-group mt-3 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
											<input name="email" id="email" type="email" class="form-control s/website.css" placeholder="Your Email*" required>
										</div>
